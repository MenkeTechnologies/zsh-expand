...
ZPWR_VARS[blackSubcommandPositionRegex]='ng|git|pod|docker|kubectl|rndc|yarn|npm|pip[0-9\.]*|bundle|rails|gem|nmcli|brew|apt|dnf|yum|zypper|pacman|proxychains[0-9\.]*|zpwr|zinit'
...
ZPWR_EXPAND_CORRECT_WORDS[directory]="dir idr direcotry direcorty directroy"
ZPWR_EXPAND_CORRECT_WORDS[directories]="dirss idrs direcotries direcorties directroies dirz"
...
ZPWR_EXPAND_CORRECT_WORDS[echo]="ehco eccho eho ceho ecoh eco"
...
ZPWR_EXPAND_CORRECT_WORDS[environment_variable]="envvar"
ZPWR_EXPAND_CORRECT_WORDS[environment_variables]="envvars"
...
ZPWR_EXPAND_CORRECT_WORDS[with]="with wiht itwh iwth wtih"
