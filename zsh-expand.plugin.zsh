...
ZPWR_CORRECT_WORDS[directories]="dirs idrs direcotries direcorties directroies"
...
ZPWR_CORRECT_WORDS[file]="feil fiel ifle fille fillee"
ZPWR_CORRECT_WORDS[files]="ifles filles filees"
