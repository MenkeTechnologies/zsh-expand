...
__CORRECT_WORDS[click]="clikc clik"
__CORRECT_WORDS[clone]="cloen"
__CORRECT_WORDS[command]="cmd comand aommnd commnd comamnd ocmmand"
...
__CORRECT_WORDS[each]="eah"
__CORRECT_WORDS[echo]="ehco eccho eho ceho ecoh eco"
__CORRECT_WORDS[EFI]="efi"
__CORRECT_WORDS[environment]="environ evn env"
...
__CORRECT_WORDS[final]="fnial fianl finl"
...
__CORRECT_WORDS[functions]="fxns funcs fns"
__CORRECT_WORDS[go]="og"
__CORRECT_WORDS[GPT]="gpt"
__CORRECT_WORDS[GPU]="gpu"
...
__CORRECT_WORDS[states]="staets stetas sttaes"
__CORRECT_WORDS[standard]="std"
...
__CORRECT_WORDS[through]="thru throug"
...
__CORRECT_WORDS[variables]="vars"
__CORRECT_WORDS[version]="verssion verion verison"
__CORRECT_WORDS[Version]="Verssion Verion Verison"
__CORRECT_WORDS[VPN]="vpn"
__CORRECT_WORDS[was_not]="wasnt"
__CORRECT_WORDS[will_not]="wont"
__CORRECT_WORDS[with]="with wiht itwh iwth wtih"
