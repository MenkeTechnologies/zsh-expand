...
ZPWR_VARS[blackSubcommandPositionRegex]='^(cargo|svn|git|ng|pod|docker|kubectl|rndc|yarn|npm|pip[0-9\.]*|bundle|rails|gem|nmcli|brew|apt|dnf|yum|zypper|pacman|proxychains[0-9\.]*|zpwr|zm|zd|zg|zinit)$'
