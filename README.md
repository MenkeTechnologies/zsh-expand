...
### [`Read the Docs`](https://menketechnologies.github.io/zsh-expand/) &middot; [`Engineering Report`](https://menketechnologies.github.io/zsh-expand/report.html)
...
**The world's most powerful zsh expansion plugin.** Intercepts your spacebar and expands everything in its path -- regular aliases, global aliases, suffix aliases, misspellings, globs, history, parameters, and more. No pipes. No external commands. Pure zsh. Sub-millisecond. 11,688 tests.
...
A large [zunit](https://github.com/zunit-zsh/zunit) suite (11,688 discrete `@test` blocks). Exact totals change frequently — print them from the repo root with:
