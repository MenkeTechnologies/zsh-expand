...
#==============================================================
# 757-token extreme chain — 12 builtin perms up front,
# then all 30 execvp commands duplicated with different flags.
# Shell builtins only appear before the first execvp wrapper.
#==============================================================

@test 'extreme757: lastword is gco' {
    zpwrExpandParseWords "nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root env -0iv -C /tmp VAR1=a VAR2=b doas -n -u deploy env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -r r1 -T 60 -t t1 -u admin env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks sudo -kE -u test env -i GOPATH=/go proxychains4 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -k 5 -s TERM 30 strace -cCdDfFhikqrtTvVwxXyYzZ -a 80 -b 32 -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u 40 -U 80 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 60 -b 16 -e malloc -E MALLOC -I 2 -o /t2 -O 25 -p 2 -P /lib -s 128 -S calls -u 20 -U 40 ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -f 10 taskset -c 0-3 watch -dgtecxbp -n 2 flock -nsux -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -l -u deploy -g staff -G docker unshare -fmnpuUirC -- cpulimit -l 50 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u www env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -k 10 -s KILL 60 strace -cfkqrTvV -e trace=file -s 512 -o /t3 ltrace -cfhikrtTvV -e open -s 64 -a 40 -o /t4 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -r 20 taskset -c 0-7 watch -dx -n 5 flock -nx -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -u op -g sys unshare -mn -- cpulimit -l 75 pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u test env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -k 2 -s HUP 15 strace -cf -e trace=open -s 64 -o /t5 ltrace -cf -e free -s 32 -a 20 -o /t6 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -i 0 taskset -c 0 watch -dt -n 1 flock -su -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -l -u svc -g svc unshare -fpU -- cpulimit -l 25 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kKnP -u op -T 120 -r mgr -t user_t env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -k 8 -s USR1 45 strace -dDfFhikwxXyYzZ -a 100 -b 64 -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u 60 -U 100 ltrace -dDfFhikwxXyYzZ -a 80 -b 48 -e write -E HOME -I 4 -o /t8 -O 50 -p 4 -P /sys -s 192 -S time -u 30 -U 60 ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -b 5 taskset -c 0-15 watch -dgtecxbp -n 3 flock -nsux -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -l -u admin -g adm -G wheel unshare -fmnpuUirC -- cpulimit -l 90 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u root env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[lastword_lbuffer] same_as 'gco'
}

@test 'extreme757: firstword is nocorrect' {
    zpwrExpandParseWords "nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root env -0iv -C /tmp VAR1=a VAR2=b doas -n -u deploy env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -r r1 -T 60 -t t1 -u admin env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks sudo -kE -u test env -i GOPATH=/go proxychains4 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -k 5 -s TERM 30 strace -cCdDfFhikqrtTvVwxXyYzZ -a 80 -b 32 -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u 40 -U 80 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 60 -b 16 -e malloc -E MALLOC -I 2 -o /t2 -O 25 -p 2 -P /lib -s 128 -S calls -u 20 -U 40 ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -f 10 taskset -c 0-3 watch -dgtecxbp -n 2 flock -nsux -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -l -u deploy -g staff -G docker unshare -fmnpuUirC -- cpulimit -l 50 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u www env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -k 10 -s KILL 60 strace -cfkqrTvV -e trace=file -s 512 -o /t3 ltrace -cfhikrtTvV -e open -s 64 -a 40 -o /t4 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -r 20 taskset -c 0-7 watch -dx -n 5 flock -nx -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -u op -g sys unshare -mn -- cpulimit -l 75 pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u test env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -k 2 -s HUP 15 strace -cf -e trace=open -s 64 -o /t5 ltrace -cf -e free -s 32 -a 20 -o /t6 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -i 0 taskset -c 0 watch -dt -n 1 flock -su -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -l -u svc -g svc unshare -fpU -- cpulimit -l 25 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kKnP -u op -T 120 -r mgr -t user_t env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -k 8 -s USR1 45 strace -dDfFhikwxXyYzZ -a 100 -b 64 -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u 60 -U 100 ltrace -dDfFhikwxXyYzZ -a 80 -b 48 -e write -E HOME -I 4 -o /t8 -O 50 -p 4 -P /sys -s 192 -S time -u 30 -U 60 ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -b 5 taskset -c 0-15 watch -dgtecxbp -n 3 flock -nsux -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -l -u admin -g adm -G wheel unshare -fmnpuUirC -- cpulimit -l 90 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u root env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[firstword_partition] same_as 'nocorrect'
}

@test 'extreme757: cachedRegexMatched is true' {
    zpwrExpandParseWords "nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root env -0iv -C /tmp VAR1=a VAR2=b doas -n -u deploy env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -r r1 -T 60 -t t1 -u admin env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks sudo -kE -u test env -i GOPATH=/go proxychains4 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -k 5 -s TERM 30 strace -cCdDfFhikqrtTvVwxXyYzZ -a 80 -b 32 -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u 40 -U 80 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 60 -b 16 -e malloc -E MALLOC -I 2 -o /t2 -O 25 -p 2 -P /lib -s 128 -S calls -u 20 -U 40 ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -f 10 taskset -c 0-3 watch -dgtecxbp -n 2 flock -nsux -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -l -u deploy -g staff -G docker unshare -fmnpuUirC -- cpulimit -l 50 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u www env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -k 10 -s KILL 60 strace -cfkqrTvV -e trace=file -s 512 -o /t3 ltrace -cfhikrtTvV -e open -s 64 -a 40 -o /t4 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -r 20 taskset -c 0-7 watch -dx -n 5 flock -nx -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -u op -g sys unshare -mn -- cpulimit -l 75 pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u test env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -k 2 -s HUP 15 strace -cf -e trace=open -s 64 -o /t5 ltrace -cf -e free -s 32 -a 20 -o /t6 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -i 0 taskset -c 0 watch -dt -n 1 flock -su -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -l -u svc -g svc unshare -fpU -- cpulimit -l 25 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kKnP -u op -T 120 -r mgr -t user_t env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -k 8 -s USR1 45 strace -dDfFhikwxXyYzZ -a 100 -b 64 -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u 60 -U 100 ltrace -dDfFhikwxXyYzZ -a 80 -b 48 -e write -E HOME -I 4 -o /t8 -O 50 -p 4 -P /sys -s 192 -S time -u 30 -U 60 ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -b 5 taskset -c 0-15 watch -dgtecxbp -n 3 flock -nsux -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -l -u admin -g adm -G wheel unshare -fmnpuUirC -- cpulimit -l 90 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u root env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[cachedRegexMatched] same_as 'true'
}

@test 'extreme757: alias expands through full chain' {
    alias gco="git checkout"
    LBUFFER="nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root env -0iv -C /tmp VAR1=a VAR2=b doas -n -u deploy env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -r r1 -T 60 -t t1 -u admin env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks sudo -kE -u test env -i GOPATH=/go proxychains4 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -k 5 -s TERM 30 strace -cCdDfFhikqrtTvVwxXyYzZ -a 80 -b 32 -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u 40 -U 80 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 60 -b 16 -e malloc -E MALLOC -I 2 -o /t2 -O 25 -p 2 -P /lib -s 128 -S calls -u 20 -U 40 ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -f 10 taskset -c 0-3 watch -dgtecxbp -n 2 flock -nsux -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -l -u deploy -g staff -G docker unshare -fmnpuUirC -- cpulimit -l 50 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u www env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -k 10 -s KILL 60 strace -cfkqrTvV -e trace=file -s 512 -o /t3 ltrace -cfhikrtTvV -e open -s 64 -a 40 -o /t4 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -r 20 taskset -c 0-7 watch -dx -n 5 flock -nx -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -u op -g sys unshare -mn -- cpulimit -l 75 pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u test env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -k 2 -s HUP 15 strace -cf -e trace=open -s 64 -o /t5 ltrace -cf -e free -s 32 -a 20 -o /t6 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -i 0 taskset -c 0 watch -dt -n 1 flock -su -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -l -u svc -g svc unshare -fpU -- cpulimit -l 25 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kKnP -u op -T 120 -r mgr -t user_t env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -k 8 -s USR1 45 strace -dDfFhikwxXyYzZ -a 100 -b 64 -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u 60 -U 100 ltrace -dDfFhikwxXyYzZ -a 80 -b 48 -e write -E HOME -I 4 -o /t8 -O 50 -p 4 -P /sys -s 192 -S time -u 30 -U 60 ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -b 5 taskset -c 0-15 watch -dgtecxbp -n 3 flock -nsux -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -l -u admin -g adm -G wheel unshare -fmnpuUirC -- cpulimit -l 90 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u root env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    ZPWR_EXPAND=true
...
# namespaced, sandboxed, caffeinated for 24 hours.
# Shell builtins only appear before the first execvp wrapper.
#==============================================================

@test 'monster: gnarly chain lastword is gco' {
    zpwrExpandParseWords "nocorrect noglob builtin eval coproc time -p command -p exec -cl -a BEAST nocorrect builtin eval noglob coproc time -v command eval nocorrect noglob builtin coproc torify sudo -kKEHnPS -g wheel -h fortress -p gco -R /dungeon -r overlord -T 9999 -t unconfined_t -u root env -0iv -C /dev/null DOOM=eternal FEAR=none PATH=/usr/games LANG=chaos CC=gcc CXX=g++ CFLAGS=-O666 LDFLAGS=-lmadness RUST_LOG=trace GOPATH=/void NODE_ENV=destruction EDITOR=ed VISUAL=ed PAGER=cat SHELL=/bin/zsh doas -s -C /etc/doas.d/monster -u _chaos torsocks sudo -kE -u daemon env -i MALLOC_CHECK_=3 LD_PRELOAD=/lib/libevil.so ASAN_OPTIONS=detect_leaks=1 UBSAN_OPTIONS=print_stacktrace=1 proxychains4 nice -n -20 nohup nice -n 19 nohup nice -n 0 nohup strace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e trace=all -E LD_LIBRARY_PATH -I 1 -o /tmp/strace.nightmare.log -O 999 -p 1 -P /proc/self/exe -s 1048576 -S calls -u 80 -U 132 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e malloc -E HOME -I 1 -o /tmp/ltrace.abyss.log -O 999 -p 1 -P /lib/x86_64-linux-gnu -s 1048576 -S time -u 80 -U 132 ionice -c 1 -n 0 caffeinate -dimsu -t 86400 -w 1 setsid -cfw chrt -f 99 taskset -c 0-63 watch -dgtecxbp -n 1 flock -nsux -w 3600 -E 42 /tmp/lock.of.ages chroot /newroot/of/all/evil runuser -l -u nobody -g nogroup -G wheel unshare -fmnpuUirC -- cpulimit -l 1 rlwrap -acirN -f /usr/share/dict/words -s 999999 -b x -H /tmp/history.of.madness -p magenta -S p1 timeout -k 1 -s KILL 86400 pkexec fakeroot unbuffer chronic valgrind daemonize firejail sem systemd-run tsocks sudo -kE -u www-data env -0iv -C /srv DATABASE_URL=postgres://doom:fire@localhost/inferno REDIS_URL=redis://localhost:6379/0 SECRET_KEY=hunter2 API_KEY=sk-AAAA doas -n -u _deploy nice -n -10 nohup strace -cfkqrTvV -e trace=network -s 4096 -o /tmp/net.log ltrace -cfhikrtTvV -e open -s 4096 -o /tmp/ssl.log ionice -t -c 2 -n 7 caffeinate -im -t 3600 setsid -f chrt -r 50 taskset -c 0 flock -x -w 60 -E 1 /tmp/final.lock chroot /srv/jail runuser -u app -g app unshare -mn -- cpulimit -l 100 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u root env -i PATH=/usr/bin LAST_WORDS=goodbye doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[lastword_lbuffer] same_as 'gco'
}

@test 'monster: gnarly chain alias expands' {
    alias gco="git checkout"
...
@test 'monster: gnarly chain cachedRegexMatched is true' {
    zpwrExpandParseWords "nocorrect noglob builtin eval coproc time -p command -p exec -cl -a BEAST nocorrect builtin eval noglob coproc time -v command eval nocorrect noglob builtin coproc torify sudo -kKEHnPS -g wheel -h fortress -p gco -R /dungeon -r overlord -T 9999 -t unconfined_t -u root env -0iv -C /dev/null DOOM=eternal FEAR=none PATH=/usr/games LANG=chaos CC=gcc CXX=g++ CFLAGS=-O666 LDFLAGS=-lmadness RUST_LOG=trace GOPATH=/void NODE_ENV=destruction EDITOR=ed VISUAL=ed PAGER=cat SHELL=/bin/zsh doas -s -C /etc/doas.d/monster -u _chaos torsocks sudo -kE -u daemon env -i MALLOC_CHECK_=3 LD_PRELOAD=/lib/libevil.so ASAN_OPTIONS=detect_leaks=1 UBSAN_OPTIONS=print_stacktrace=1 proxychains4 nice -n -20 nohup nice -n 19 nohup nice -n 0 nohup strace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e trace=all -E LD_LIBRARY_PATH -I 1 -o /tmp/strace.nightmare.log -O 999 -p 1 -P /proc/self/exe -s 1048576 -S calls -u 80 -U 132 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e malloc -E HOME -I 1 -o /tmp/ltrace.abyss.log -O 999 -p 1 -P /lib/x86_64-linux-gnu -s 1048576 -S time -u 80 -U 132 ionice -c 1 -n 0 caffeinate -dimsu -t 86400 -w 1 setsid -cfw chrt -f 99 taskset -c 0-63 watch -dgtecxbp -n 1 flock -nsux -w 3600 -E 42 /tmp/lock.of.ages chroot /newroot/of/all/evil runuser -l -u nobody -g nogroup -G wheel unshare -fmnpuUirC -- cpulimit -l 1 rlwrap -acirN -f /usr/share/dict/words -s 999999 -b x -H /tmp/history.of.madness -p magenta -S p1 timeout -k 1 -s KILL 86400 pkexec fakeroot unbuffer chronic valgrind daemonize firejail sem systemd-run tsocks sudo -kE -u www-data env -0iv -C /srv DATABASE_URL=postgres://doom:fire@localhost/inferno REDIS_URL=redis://localhost:6379/0 SECRET_KEY=hunter2 API_KEY=sk-AAAA doas -n -u _deploy nice -n -10 nohup strace -cfkqrTvV -e trace=network -s 4096 -o /tmp/net.log ltrace -cfhikrtTvV -e open -s 4096 -o /tmp/ssl.log ionice -t -c 2 -n 7 caffeinate -im -t 3600 setsid -f chrt -r 50 taskset -c 0 flock -x -w 60 -E 1 /tmp/final.lock chroot /srv/jail runuser -u app -g app unshare -mn -- cpulimit -l 100 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run sudo -kE -u root env -i PATH=/usr/bin LAST_WORDS=goodbye doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[cachedRegexMatched] same_as 'true'
}
