...
@test 'monster: lastword is gco' {
    zpwrExpandParseWords "nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root su -l deploy env -0iv -C /tmp VAR1=a VAR2=b doas -n -u ops env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -r r1 -T 60 -t t1 -u admin su -flm root env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks sudo -kE -u test env -i GOPATH=/go proxychains4 su -s /bin/zsh -g staff root stdbuf -i 0 -o L -e 0 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -k 5 -s TERM 30 strace -cCdDfFhikqrtTvVwxXyYzZ -a 80 -b 32 -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u 40 -U 80 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 60 -b 16 -e malloc -E MALLOC -I 2 -o /t2 -O 25 -p 2 -P /lib -s 128 -S calls -u 20 -U 40 ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -f 10 taskset -c 0-3 watch -dgtecxbp -n 2 nsenter -t 1 -m -u -i -n -p numactl -C 0-3 -m 0 choom -n -500 sg staff flock -nsux -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -l -u deploy -g staff -G docker unshare -fmnpuUirC -- prlimit --nofile=4096 cpulimit -l 50 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u www su root stdbuf -oL env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -k 10 -s KILL 60 strace -cfkqrTvV -e trace=file -s 512 -o /t3 ltrace -cfhikrtTvV -e open -s 64 -a 40 -o /t4 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -r 20 taskset -c 0-7 watch -dx -n 5 nsenter -t 2 -m numactl -i all choom -n -1000 flock -nx -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -u op -g sys unshare -mn -- prlimit --nproc=512 cpulimit -l 75 pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u test su -l svc stdbuf -e0 env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -k 2 -s HUP 15 strace -cf -e trace=open -s 64 -o /t5 ltrace -cf -e free -s 32 -a 20 -o /t6 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -i 0 taskset -c 0 watch -dt -n 1 nsenter -t 3 -n sg wheel flock -su -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -l -u svc -g svc unshare -fpU -- prlimit --stack=8192 cpulimit -l 25 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kKnP -u op -T 120 -r mgr -t user_t su -P root env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -k 8 -s USR1 45 strace -dDfFhikwxXyYzZ -a 100 -b 64 -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u 60 -U 100 ltrace -dDfFhikwxXyYzZ -a 80 -b 48 -e write -E HOME -I 4 -o /t8 -O 50 -p 4 -P /sys -s 192 -S time -u 30 -U 60 ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -b 5 taskset -c 0-15 watch -dgtecxbp -n 3 nsenter -t 4 -m -u numactl -N 0 -m 0 choom -n 100 flock -nsux -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -l -u admin -g adm -G wheel unshare -fmnpuUirC -- prlimit --memlock=unlimited cpulimit -l 90 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u root su root stdbuf -o0 env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
...
@test 'monster: alias expands through full chain' {
    ...
    LBUFFER="nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root su -l deploy env -0iv -C /tmp VAR1=a VAR2=b doas -n -u ops env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -r r1 -T 60 -t t1 -u admin su -flm root env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks sudo -kE -u test env -i GOPATH=/go proxychains4 su -s /bin/zsh -g staff root stdbuf -i 0 -o L -e 0 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -k 5 -s TERM 30 strace -cCdDfFhikqrtTvVwxXyYzZ -a 80 -b 32 -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u 40 -U 80 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 60 -b 16 -e malloc -E MALLOC -I 2 -o /t2 -O 25 -p 2 -P /lib -s 128 -S calls -u 20 -U 40 ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -f 10 taskset -c 0-3 watch -dgtecxbp -n 2 nsenter -t 1 -m -u -i -n -p numactl -C 0-3 -m 0 choom -n -500 sg staff flock -nsux -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -l -u deploy -g staff -G docker unshare -fmnpuUirC -- prlimit --nofile=4096 cpulimit -l 50 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u www su root stdbuf -oL env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -k 10 -s KILL 60 strace -cfkqrTvV -e trace=file -s 512 -o /t3 ltrace -cfhikrtTvV -e open -s 64 -a 40 -o /t4 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -r 20 taskset -c 0-7 watch -dx -n 5 nsenter -t 2 -m numactl -i all choom -n -1000 flock -nx -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -u op -g sys unshare -mn -- prlimit --nproc=512 cpulimit -l 75 pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u test su -l svc stdbuf -e0 env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -k 2 -s HUP 15 strace -cf -e trace=open -s 64 -o /t5 ltrace -cf -e free -s 32 -a 20 -o /t6 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -i 0 taskset -c 0 watch -dt -n 1 nsenter -t 3 -n sg wheel flock -su -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -l -u svc -g svc unshare -fpU -- prlimit --stack=8192 cpulimit -l 25 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kKnP -u op -T 120 -r mgr -t user_t su -P root env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -k 8 -s USR1 45 strace -dDfFhikwxXyYzZ -a 100 -b 64 -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u 60 -U 100 ltrace -dDfFhikwxXyYzZ -a 80 -b 48 -e write -E HOME -I 4 -o /t8 -O 50 -p 4 -P /sys -s 192 -S time -u 30 -U 60 ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -b 5 taskset -c 0-15 watch -dgtecxbp -n 3 nsenter -t 4 -m -u numactl -N 0 -m 0 choom -n 100 flock -nsux -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -l -u admin -g adm -G wheel unshare -fmnpuUirC -- prlimit --memlock=unlimited cpulimit -l 90 pkexec fakeroot unbuffer chronic valgrind torify torsocks tsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u root su root stdbuf -o0 env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    ZPWR_EXPAND=true
