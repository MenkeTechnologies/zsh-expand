...
#==============================================================
# Monster chain — 12 builtin perms, all command wrappers
# with verified flags including new sudo/doas/env/rlwrap/strace/ltrace
# separate branches, --, and all formerly-bare wrappers with their flags
#==============================================================

@test 'monster: lastword is gco' {
    zpwrExpandParseWords "nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root su -lT deploy env -0iv -C /tmp VAR1=a VAR2=b doas -Lns -u ops env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -D /d1 -T 60 -U deploy -u admin su -flmT root env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass sudo -kE -u test env -i GOPATH=/go proxychains4 su -s /bin/zsh -g staff root stdbuf -i 0 -o L -e 0 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -fpv -k 5 -s TERM 30 strace -AcCdDfFhiknNqrtTvVwxyYzZ -a 80 -b execve -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u strace -U 80 -X raw ltrace -bcCfhiLrStTV -a 60 -A 10 -D 0xff -e malloc -F /etc/ltrace.conf -l libc -n 2 -o /t2 -p 2 -s 128 -u ltrace -w 3 -x dlopen ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -adepRv -D 1000 -T 500 -f 10 taskset -acp 0-3 -- watch -bdCcefgprtwx -n 2 -q 5 -s /dir -- nsenter -aceiFmnpruUCTwWZ -t 1 -S 0 -G 0 -N 3 -- numactl -absHl -C 0-3 -i all -m 0 -N 0 -p 1 -w 0 -P 1 -- choom -n -500 sg staff flock -eFnosux -c cmd -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -fmlpPT -c cmd -u deploy -g staff -s /bin/bash -G docker -w 1,2 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --nofile=4096 cpulimit -viz -e app -p 1 -l 50 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u www su root stdbuf -oL env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -fpv -k 10 -s KILL 60 strace -ANnwcfkqrTvV -e trace=file -s 512 -o /t3 -X raw ltrace -bcCfhiLrStTV -e open -s 64 -a 40 -o /t4 -l libc -n 1 -w 1 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -adepRv -r 20 taskset -acp 0-7 -- watch -bdefprtwx -n 5 -q 3 -s /d3 -- nsenter -aceZTwW -t 2 -S 1 -G 1 -N 4 -- numactl -absH -i all -w 1 -P 2 -- choom -n -1000 flock -eFnox -c cmd -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -fmpPT -u op -c cmd -g sys -s /bin/zsh -w 1 -- unshare -cfmnpuUirCT -R /nr -S 500 -G 500 -l /ns2 -- prlimit --nproc=512 cpulimit -viz -e app2 -p 2 -l 75 -- pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u test su -l svc stdbuf -e0 env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -fpv -k 2 -s HUP 15 strace -ANnwcf -e trace=open -s 64 -o /t5 -X raw ltrace -bcCfiL -e free -s 32 -a 20 -o /t6 -l libc -n 1 -w 1 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -adepRv -i 0 taskset -acp 0 -- watch -bdCcefgprtwx -n 1 -q 1 -s /d4 -- nsenter -aceFmnZ -t 3 -S 2 -G 2 -N 5 -- sg wheel flock -eFosu -c cmd -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -flmpPT -u svc -c cmd -g svc -s /bin/sh -w 2 -- unshare -cfpUT -R /nr2 -S 0 -G 0 -l /ns3 -- prlimit --stack=8192 cpulimit -viz -e app3 -p 3 -l 25 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kKnP -u op -T 120 -D /tmp -U mgr su -PT root env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -fpv -k 8 -s USR1 45 strace -AcDdFfhikNnqrtTvVwxyYzZ -a 100 -b execve -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u strace -U 100 -X raw ltrace -bcCfhiLrStTV -a 80 -A 20 -D 0xf0 -e write -F /etc/lt2.conf -l libm -n 4 -o /t8 -p 4 -s 192 -u ltrace -w 5 -x open ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -adepRv -b 5 taskset -acp 0-15 -- watch -bdCcefgprtwx -n 3 -q 10 -s /d2 -- nsenter -aceimnpruUCTwWZ -t 4 -S 3 -G 3 -N 6 -- numactl -absHl -N 0 -m 0 -w 2 -P 3 -- choom -n 100 flock -eFnosux -c cmd -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -fmlpPT -u admin -c cmd -g adm -s /bin/bash -G wheel -w 3 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --memlock=unlimited cpulimit -viz -e app4 -p 4 -l 90 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u root su root stdbuf -o0 env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[lastword_lbuffer] same_as 'gco'
}

@test 'monster: firstword is nocorrect' {
    zpwrExpandParseWords "nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root su -lT deploy env -0iv -C /tmp VAR1=a VAR2=b doas -Lns -u ops env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -D /d1 -T 60 -U deploy -u admin su -flmT root env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass sudo -kE -u test env -i GOPATH=/go proxychains4 su -s /bin/zsh -g staff root stdbuf -i 0 -o L -e 0 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -fpv -k 5 -s TERM 30 strace -AcCdDfFhiknNqrtTvVwxyYzZ -a 80 -b execve -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u strace -U 80 -X raw ltrace -bcCfhiLrStTV -a 60 -A 10 -D 0xff -e malloc -F /etc/ltrace.conf -l libc -n 2 -o /t2 -p 2 -s 128 -u ltrace -w 3 -x dlopen ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -adepRv -D 1000 -T 500 -f 10 taskset -acp 0-3 -- watch -bdCcefgprtwx -n 2 -q 5 -s /dir -- nsenter -aceiFmnpruUCTwWZ -t 1 -S 0 -G 0 -N 3 -- numactl -absHl -C 0-3 -i all -m 0 -N 0 -p 1 -w 0 -P 1 -- choom -n -500 sg staff flock -eFnosux -c cmd -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -fmlpPT -c cmd -u deploy -g staff -s /bin/bash -G docker -w 1,2 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --nofile=4096 cpulimit -viz -e app -p 1 -l 50 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u www su root stdbuf -oL env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -fpv -k 10 -s KILL 60 strace -ANnwcfkqrTvV -e trace=file -s 512 -o /t3 -X raw ltrace -bcCfhiLrStTV -e open -s 64 -a 40 -o /t4 -l libc -n 1 -w 1 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -adepRv -r 20 taskset -acp 0-7 -- watch -bdefprtwx -n 5 -q 3 -s /d3 -- nsenter -aceZTwW -t 2 -S 1 -G 1 -N 4 -- numactl -absH -i all -w 1 -P 2 -- choom -n -1000 flock -eFnox -c cmd -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -fmpPT -u op -c cmd -g sys -s /bin/zsh -w 1 -- unshare -cfmnpuUirCT -R /nr -S 500 -G 500 -l /ns2 -- prlimit --nproc=512 cpulimit -viz -e app2 -p 2 -l 75 -- pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u test su -l svc stdbuf -e0 env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -fpv -k 2 -s HUP 15 strace -ANnwcf -e trace=open -s 64 -o /t5 -X raw ltrace -bcCfiL -e free -s 32 -a 20 -o /t6 -l libc -n 1 -w 1 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -adepRv -i 0 taskset -acp 0 -- watch -bdCcefgprtwx -n 1 -q 1 -s /d4 -- nsenter -aceFmnZ -t 3 -S 2 -G 2 -N 5 -- sg wheel flock -eFosu -c cmd -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -flmpPT -u svc -c cmd -g svc -s /bin/sh -w 2 -- unshare -cfpUT -R /nr2 -S 0 -G 0 -l /ns3 -- prlimit --stack=8192 cpulimit -viz -e app3 -p 3 -l 25 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kKnP -u op -T 120 -D /tmp -U mgr su -PT root env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -fpv -k 8 -s USR1 45 strace -AcDdFfhikNnqrtTvVwxyYzZ -a 100 -b execve -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u strace -U 100 -X raw ltrace -bcCfhiLrStTV -a 80 -A 20 -D 0xf0 -e write -F /etc/lt2.conf -l libm -n 4 -o /t8 -p 4 -s 192 -u ltrace -w 5 -x open ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -adepRv -b 5 taskset -acp 0-15 -- watch -bdCcefgprtwx -n 3 -q 10 -s /d2 -- nsenter -aceimnpruUCTwWZ -t 4 -S 3 -G 3 -N 6 -- numactl -absHl -N 0 -m 0 -w 2 -P 3 -- choom -n 100 flock -eFnosux -c cmd -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -fmlpPT -u admin -c cmd -g adm -s /bin/bash -G wheel -w 3 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --memlock=unlimited cpulimit -viz -e app4 -p 4 -l 90 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u root su root stdbuf -o0 env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[firstword_partition] same_as 'nocorrect'
}

@test 'monster: cachedRegexMatched is true' {
    zpwrExpandParseWords "nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root su -lT deploy env -0iv -C /tmp VAR1=a VAR2=b doas -Lns -u ops env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -D /d1 -T 60 -U deploy -u admin su -flmT root env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass sudo -kE -u test env -i GOPATH=/go proxychains4 su -s /bin/zsh -g staff root stdbuf -i 0 -o L -e 0 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -fpv -k 5 -s TERM 30 strace -AcCdDfFhiknNqrtTvVwxyYzZ -a 80 -b execve -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u strace -U 80 -X raw ltrace -bcCfhiLrStTV -a 60 -A 10 -D 0xff -e malloc -F /etc/ltrace.conf -l libc -n 2 -o /t2 -p 2 -s 128 -u ltrace -w 3 -x dlopen ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -adepRv -D 1000 -T 500 -f 10 taskset -acp 0-3 -- watch -bdCcefgprtwx -n 2 -q 5 -s /dir -- nsenter -aceiFmnpruUCTwWZ -t 1 -S 0 -G 0 -N 3 -- numactl -absHl -C 0-3 -i all -m 0 -N 0 -p 1 -w 0 -P 1 -- choom -n -500 sg staff flock -eFnosux -c cmd -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -fmlpPT -c cmd -u deploy -g staff -s /bin/bash -G docker -w 1,2 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --nofile=4096 cpulimit -viz -e app -p 1 -l 50 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u www su root stdbuf -oL env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -fpv -k 10 -s KILL 60 strace -ANnwcfkqrTvV -e trace=file -s 512 -o /t3 -X raw ltrace -bcCfhiLrStTV -e open -s 64 -a 40 -o /t4 -l libc -n 1 -w 1 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -adepRv -r 20 taskset -acp 0-7 -- watch -bdefprtwx -n 5 -q 3 -s /d3 -- nsenter -aceZTwW -t 2 -S 1 -G 1 -N 4 -- numactl -absH -i all -w 1 -P 2 -- choom -n -1000 flock -eFnox -c cmd -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -fmpPT -u op -c cmd -g sys -s /bin/zsh -w 1 -- unshare -cfmnpuUirCT -R /nr -S 500 -G 500 -l /ns2 -- prlimit --nproc=512 cpulimit -viz -e app2 -p 2 -l 75 -- pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u test su -l svc stdbuf -e0 env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -fpv -k 2 -s HUP 15 strace -ANnwcf -e trace=open -s 64 -o /t5 -X raw ltrace -bcCfiL -e free -s 32 -a 20 -o /t6 -l libc -n 1 -w 1 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -adepRv -i 0 taskset -acp 0 -- watch -bdCcefgprtwx -n 1 -q 1 -s /d4 -- nsenter -aceFmnZ -t 3 -S 2 -G 2 -N 5 -- sg wheel flock -eFosu -c cmd -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -flmpPT -u svc -c cmd -g svc -s /bin/sh -w 2 -- unshare -cfpUT -R /nr2 -S 0 -G 0 -l /ns3 -- prlimit --stack=8192 cpulimit -viz -e app3 -p 3 -l 25 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kKnP -u op -T 120 -D /tmp -U mgr su -PT root env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -fpv -k 8 -s USR1 45 strace -AcDdFfhikNnqrtTvVwxyYzZ -a 100 -b execve -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u strace -U 100 -X raw ltrace -bcCfhiLrStTV -a 80 -A 20 -D 0xf0 -e write -F /etc/lt2.conf -l libm -n 4 -o /t8 -p 4 -s 192 -u ltrace -w 5 -x open ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -adepRv -b 5 taskset -acp 0-15 -- watch -bdCcefgprtwx -n 3 -q 10 -s /d2 -- nsenter -aceimnpruUCTwWZ -t 4 -S 3 -G 3 -N 6 -- numactl -absHl -N 0 -m 0 -w 2 -P 3 -- choom -n 100 flock -eFnosux -c cmd -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -fmlpPT -u admin -c cmd -g adm -s /bin/bash -G wheel -w 3 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --memlock=unlimited cpulimit -viz -e app4 -p 4 -l 90 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u root su root stdbuf -o0 env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[cachedRegexMatched] same_as 'true'
}

@test 'monster: alias expands through full chain' {
    alias gco="git checkout"
    LBUFFER="nocorrect time -p command -p builtin eval noglob coproc exec -cl -a p1 nocorrect builtin eval noglob coproc time -l command -p nocorrect noglob builtin eval coproc time -v command builtin nocorrect eval noglob coproc eval nocorrect noglob builtin coproc noglob nocorrect builtin eval coproc time -p command -p exec -c -a p2 builtin eval nocorrect noglob coproc coproc nocorrect noglob builtin eval time -l command -p builtin eval nocorrect noglob coproc time -v command -p eval noglob nocorrect builtin coproc noglob coproc nocorrect builtin eval time -p command nocorrect eval noglob builtin coproc torify sudo -kE -u root su -lT deploy env -0iv -C /tmp VAR1=a VAR2=b doas -Lns -u ops env FOO=bar BAZ=qux LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -D /d1 -T 60 -U deploy -u admin su -flmT root env -i HOME=/r1 PATH=/b1 TERM=x1 doas -s -C /etc/d1 env -u DISPLAY TERM=xterm-256 sudo -kKi -u nobody env -v -C /var CC=gcc CFLAGS=-O2 sudo -kE -u daemon env -0i -C /opt RUST_LOG=debug doas -n -u _www env -i SHELL=/bin/zsh EDITOR=vim torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass sudo -kE -u test env -i GOPATH=/go proxychains4 su -s /bin/zsh -g staff root stdbuf -i 0 -o L -e 0 nice -n 10 nohup nice -n 5 nohup nice -n 1 nohup nice -n 19 nohup nice -n 15 nohup nice -n 12 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -fpv -k 5 -s TERM 30 strace -AcCdDfFhiknNqrtTvVwxyYzZ -a 80 -b execve -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u strace -U 80 -X raw ltrace -bcCfhiLrStTV -a 60 -A 10 -D 0xff -e malloc -F /etc/ltrace.conf -l libc -n 2 -o /t2 -p 2 -s 128 -u ltrace -w 3 -x dlopen ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -adepRv -D 1000 -T 500 -f 10 taskset -acp 0-3 -- watch -bdCcefgprtwx -n 2 -q 5 -s /dir -- nsenter -aceiFmnpruUCTwWZ -t 1 -S 0 -G 0 -N 3 -- numactl -absHl -C 0-3 -i all -m 0 -N 0 -p 1 -w 0 -P 1 -- choom -n -500 sg staff flock -eFnosux -c cmd -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -fmlpPT -c cmd -u deploy -g staff -s /bin/bash -G docker -w 1,2 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --nofile=4096 cpulimit -viz -e app -p 1 -l 50 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u www su root stdbuf -oL env -0i -C /v2 PATH=/b2 GOPATH=/go doas -n -u _httpd nice -n 8 nohup nice -n 3 nohup rlwrap -acN -f /d2 -s 1000 -b y -H /h2 -p blue -S p2 timeout -fpv -k 10 -s KILL 60 strace -ANnwcfkqrTvV -e trace=file -s 512 -o /t3 -X raw ltrace -bcCfhiLrStTV -e open -s 64 -a 40 -o /t4 -l libc -n 1 -w 1 ionice -c 1 -n 3 caffeinate -im -t 120 setsid -f chrt -adepRv -r 20 taskset -acp 0-7 -- watch -bdefprtwx -n 5 -q 3 -s /d3 -- nsenter -aceZTwW -t 2 -S 1 -G 1 -N 4 -- numactl -absH -i all -w 1 -P 2 -- choom -n -1000 flock -eFnox -c cmd -w 3 -E 3 /tmp/lk2 chroot /nr2 runuser -fmpPT -u op -c cmd -g sys -s /bin/zsh -w 1 -- unshare -cfmnpuUirCT -R /nr -S 500 -G 500 -l /ns2 -- prlimit --nproc=512 cpulimit -viz -e app2 -p 2 -l 75 -- pkexec fakeroot unbuffer chronic valgrind torify torsocks proxychains4 daemonize firejail sem systemd-run dbus-run-session sudo -kE -u test su -l svc stdbuf -e0 env -i RUST_LOG=trace NODE_ENV=prod doas -n -u _test nice -n 7 nohup nice -n 2 nohup rlwrap -air -f /d3 -s 200 -b z -H /h3 -p green -S p3 timeout -fpv -k 2 -s HUP 15 strace -ANnwcf -e trace=open -s 64 -o /t5 -X raw ltrace -bcCfiL -e free -s 32 -a 20 -o /t6 -l libc -n 1 -w 1 ionice -t -c 3 -n 0 caffeinate -d -t 30 setsid -cfw chrt -adepRv -i 0 taskset -acp 0 -- watch -bdCcefgprtwx -n 1 -q 1 -s /d4 -- nsenter -aceFmnZ -t 3 -S 2 -G 2 -N 5 -- sg wheel flock -eFosu -c cmd -w 1 -E 1 /tmp/lk3 chroot /nr3 runuser -flmpPT -u svc -c cmd -g svc -s /bin/sh -w 2 -- unshare -cfpUT -R /nr2 -S 0 -G 0 -l /ns3 -- prlimit --stack=8192 cpulimit -viz -e app3 -p 3 -l 25 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kKnP -u op -T 120 -D /tmp -U mgr su -PT root env -0iv -C /run DB=pg REDIS=6379 doas -s -C /etc/d2 nice -n 14 nohup nice -n 9 nohup nice -n 4 nohup rlwrap -aciN -f /d4 -s 750 -b w -H /h4 -p cyan -S p4 timeout -fpv -k 8 -s USR1 45 strace -AcDdFfhikNnqrtTvVwxyYzZ -a 100 -b execve -e trace=desc -E PATH -I 3 -o /t7 -O 75 -p 3 -P /dev -s 384 -S calls -u strace -U 100 -X raw ltrace -bcCfhiLrStTV -a 80 -A 20 -D 0xf0 -e write -F /etc/lt2.conf -l libm -n 4 -o /t8 -p 4 -s 192 -u ltrace -w 5 -x open ionice -t -c 2 -n 5 caffeinate -dimsu -t 90 -w 5678 setsid -cf chrt -adepRv -b 5 taskset -acp 0-15 -- watch -bdCcefgprtwx -n 3 -q 10 -s /d2 -- nsenter -aceimnpruUCTwWZ -t 4 -S 3 -G 3 -N 6 -- numactl -absHl -N 0 -m 0 -w 2 -P 3 -- choom -n 100 flock -eFnosux -c cmd -w 15 -E 4 /tmp/lk4 chroot /nr4 runuser -fmlpPT -u admin -c cmd -g adm -s /bin/bash -G wheel -w 3 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --memlock=unlimited cpulimit -viz -e app4 -p 4 -l 90 -- pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u root su root stdbuf -o0 env -0iv -C /final VAR=last FINAL=yes doas -n -u root nice -n 0 nohup time -v gco"
    ZPWR_EXPAND=true
...
@test 'stress100k: 20K tokens expand through 107 loops' {
    alias gco="git checkout"
    local BLOCK="nocorrect builtin eval noglob coproc time -p command -p sudo -kE -u root env -0iv -C /tmp VAR1=a doas -n -u deploy env FOO=bar LANG=C sudo -ABbHnPS -g wheel -h h1 -p pw -R /ch -D /d1 -T 60 -U deploy -u admin env -i HOME=/r1 PATH=/b1 TERM=x1 nice -n 10 nohup nice -n 5 nohup rlwrap -acirN -f /d1 -s 500 -b x -H /h1 -p red -S p1 timeout -fpv -k 5 -s TERM 30 strace -AcCdDfFhiknNqrtTvVwxyYzZ -a 80 -b execve -e trace=network -E LD -I 1 -o /t1 -O 50 -p 1 -P /proc -s 256 -S time -u strace -U 80 -X raw ltrace -bcCfhiLrStTV -a 60 -A 10 -D 0xff -e malloc -F /etc/ltrace.conf -l libc -n 2 -o /t2 -p 2 -s 128 -u ltrace -w 3 -x dlopen ionice -t -c 2 -n 7 caffeinate -dimsu -t 60 -w 1234 setsid -cf chrt -adepRv -D 1000 -T 500 -f 10 taskset -acp 0-3 -- watch -bdCcefgprtwx -n 2 -q 5 -s /dir -- flock -eFnosux -c cmd -w 10 -E 2 /tmp/lk1 chroot /nr1 runuser -fmlpPT -c cmd -u deploy -g staff -s /bin/bash -G docker -w 1,2 -- unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- cpulimit -viz -e app -p 1 -l 50 -- pkexec -u admin --keep-cwd fakeroot -u -- unbuffer -p chronic -ev -- valgrind -qv -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 tsocks proxychains4 -q daemonize -v -- firejail -- sem -j 4 -- systemd-run -dGqt -- nocache -- fakechroot -s -- ccache distcc dbus-launch -- dbus-run-session -- eatmydata -- catchsegv "
    LBUFFER=""
    for i in {1..50}; do
        LBUFFER+="$BLOCK"
    done
...
# namespaced, NUMA-pinned, OOM-adjusted, stream-buffered,
# resource-limited, caffeinated for 24 hours
#==============================================================

@test 'gnarly: lastword is gco' {
    zpwrExpandParseWords "nocorrect noglob builtin eval coproc time -p command -p exec -cl -a BEAST nocorrect builtin eval noglob coproc time -v command eval nocorrect noglob builtin coproc torify sudo -kKEHnPS -g wheel -h fortress -p gco -R /dungeon -r overlord -T 9999 -t unconfined_t -u root su -lT deploy env -0iv -C /dev/null DOOM=eternal FEAR=none PATH=/usr/games LANG=chaos CC=gcc CXX=g++ CFLAGS=-O666 LDFLAGS=-lmadness RUST_LOG=trace GOPATH=/void NODE_ENV=destruction EDITOR=ed VISUAL=ed PAGER=cat SHELL=/bin/zsh doas -s -C /etc/doas.d/monster -u _chaos torsocks sudo -kE -u daemon su root env -i MALLOC_CHECK_=3 LD_PRELOAD=/lib/libevil.so ASAN_OPTIONS=detect_leaks=1 UBSAN_OPTIONS=print_stacktrace=1 proxychains4 stdbuf -i 0 -o L -e 0 nice -n -20 nohup nice -n 19 nohup nice -n 0 nohup strace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e trace=all -E LD_LIBRARY_PATH -I 1 -o /tmp/strace.nightmare.log -O 999 -p 1 -P /proc/self/exe -s 1048576 -S calls -u 80 -U 132 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e malloc -E HOME -I 1 -o /tmp/ltrace.abyss.log -O 999 -p 1 -P /lib/x86_64-linux-gnu -s 1048576 -S time -u 80 -U 132 ionice -c 1 -n 0 caffeinate -dimsu -t 86400 -w 1 setsid -cfw chrt -f 99 taskset -c 0-63 nsenter -aceiFmnpruUCTwWZ -t 1 -S 0 -G 0 -N 3 -- numactl -C 0-63 -m all choom -n -1000 sg nogroup watch -dgtecxbp -n 1 flock -nsux -w 3600 -E 42 /tmp/lock.of.ages chroot /newroot/of/all/evil runuser -l -u nobody -g nogroup -G wheel unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --nofile=1048576 --nproc=unlimited cpulimit -l 1 rlwrap -acirN -f /usr/share/dict/words -s 999999 -b x -H /tmp/history.of.madness -p magenta -S p1 timeout -k 1 -s KILL 86400 pkexec fakeroot unbuffer chronic valgrind daemonize firejail sem systemd-run dbus-run-session tsocks sudo -kE -u www-data su -l app stdbuf -oL env -0iv -C /srv DATABASE_URL=postgres://doom:fire@localhost/inferno REDIS_URL=redis://localhost:6379/0 SECRET_KEY=hunter2 API_KEY=sk-AAAA doas -n -u _deploy nice -n -10 nohup strace -cfkqrTvV -e trace=network -s 4096 -o /tmp/net.log ltrace -cfhikrtTvV -e open -s 4096 -o /tmp/ssl.log ionice -t -c 2 -n 7 caffeinate -im -t 3600 setsid -f chrt -r 50 taskset -c 0 nsenter -aceZTwW -t 2 -S 1 -G 1 -N 4 -- -n numactl -absH -i all -w 1 -P 2 -- choom -n 500 flock -x -w 60 -E 1 /tmp/final.lock chroot /srv/jail runuser -u app -g app unshare -cfmnpuUirCT -R /nr -S 500 -G 500 -l /ns2 -- prlimit --memlock=unlimited cpulimit -l 100 pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u root su root stdbuf -o0 env -i PATH=/usr/bin LAST_WORDS=goodbye doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[lastword_lbuffer] same_as 'gco'
}

@test 'gnarly: alias expands through full chain' {
    alias gco="git checkout"
    LBUFFER="nocorrect noglob builtin eval coproc time -p command -p exec -cl -a BEAST nocorrect builtin eval noglob coproc time -v command eval nocorrect noglob builtin coproc torify sudo -kKEHnPS -g wheel -h fortress -p gco -R /dungeon -r overlord -T 9999 -t unconfined_t -u root su -lT deploy env -0iv -C /dev/null DOOM=eternal FEAR=none PATH=/usr/games LANG=chaos CC=gcc CXX=g++ CFLAGS=-O666 LDFLAGS=-lmadness RUST_LOG=trace GOPATH=/void NODE_ENV=destruction EDITOR=ed VISUAL=ed PAGER=cat SHELL=/bin/zsh doas -s -C /etc/doas.d/monster -u _chaos torsocks sudo -kE -u daemon su root env -i MALLOC_CHECK_=3 LD_PRELOAD=/lib/libevil.so ASAN_OPTIONS=detect_leaks=1 UBSAN_OPTIONS=print_stacktrace=1 proxychains4 stdbuf -i 0 -o L -e 0 nice -n -20 nohup nice -n 19 nohup nice -n 0 nohup strace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e trace=all -E LD_LIBRARY_PATH -I 1 -o /tmp/strace.nightmare.log -O 999 -p 1 -P /proc/self/exe -s 1048576 -S calls -u 80 -U 132 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e malloc -E HOME -I 1 -o /tmp/ltrace.abyss.log -O 999 -p 1 -P /lib/x86_64-linux-gnu -s 1048576 -S time -u 80 -U 132 ionice -c 1 -n 0 caffeinate -dimsu -t 86400 -w 1 setsid -cfw chrt -f 99 taskset -c 0-63 nsenter -aceiFmnpruUCTwWZ -t 1 -S 0 -G 0 -N 3 -- numactl -C 0-63 -m all choom -n -1000 sg nogroup watch -dgtecxbp -n 1 flock -nsux -w 3600 -E 42 /tmp/lock.of.ages chroot /newroot/of/all/evil runuser -l -u nobody -g nogroup -G wheel unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --nofile=1048576 --nproc=unlimited cpulimit -l 1 rlwrap -acirN -f /usr/share/dict/words -s 999999 -b x -H /tmp/history.of.madness -p magenta -S p1 timeout -k 1 -s KILL 86400 pkexec fakeroot unbuffer chronic valgrind daemonize firejail sem systemd-run dbus-run-session tsocks sudo -kE -u www-data su -l app stdbuf -oL env -0iv -C /srv DATABASE_URL=postgres://doom:fire@localhost/inferno REDIS_URL=redis://localhost:6379/0 SECRET_KEY=hunter2 API_KEY=sk-AAAA doas -n -u _deploy nice -n -10 nohup strace -cfkqrTvV -e trace=network -s 4096 -o /tmp/net.log ltrace -cfhikrtTvV -e open -s 4096 -o /tmp/ssl.log ionice -t -c 2 -n 7 caffeinate -im -t 3600 setsid -f chrt -r 50 taskset -c 0 nsenter -aceZTwW -t 2 -S 1 -G 1 -N 4 -- -n numactl -absH -i all -w 1 -P 2 -- choom -n 500 flock -x -w 60 -E 1 /tmp/final.lock chroot /srv/jail runuser -u app -g app unshare -cfmnpuUirCT -R /nr -S 500 -G 500 -l /ns2 -- prlimit --memlock=unlimited cpulimit -l 100 pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u root su root stdbuf -o0 env -i PATH=/usr/bin LAST_WORDS=goodbye doas -n -u root nice -n 0 nohup time -v gco"
    ZPWR_EXPAND=true
    ZPWR_EXPAND_SECOND_POSITION=true
    zpwrExpandParseWords "$LBUFFER"
    zpwrExpandRegexMatchOnCommandPosition
...
@test 'gnarly: cachedRegexMatched is true' {
    zpwrExpandParseWords "nocorrect noglob builtin eval coproc time -p command -p exec -cl -a BEAST nocorrect builtin eval noglob coproc time -v command eval nocorrect noglob builtin coproc torify sudo -kKEHnPS -g wheel -h fortress -p gco -R /dungeon -r overlord -T 9999 -t unconfined_t -u root su -lT deploy env -0iv -C /dev/null DOOM=eternal FEAR=none PATH=/usr/games LANG=chaos CC=gcc CXX=g++ CFLAGS=-O666 LDFLAGS=-lmadness RUST_LOG=trace GOPATH=/void NODE_ENV=destruction EDITOR=ed VISUAL=ed PAGER=cat SHELL=/bin/zsh doas -s -C /etc/doas.d/monster -u _chaos torsocks sudo -kE -u daemon su root env -i MALLOC_CHECK_=3 LD_PRELOAD=/lib/libevil.so ASAN_OPTIONS=detect_leaks=1 UBSAN_OPTIONS=print_stacktrace=1 proxychains4 stdbuf -i 0 -o L -e 0 nice -n -20 nohup nice -n 19 nohup nice -n 0 nohup strace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e trace=all -E LD_LIBRARY_PATH -I 1 -o /tmp/strace.nightmare.log -O 999 -p 1 -P /proc/self/exe -s 1048576 -S calls -u 80 -U 132 ltrace -cCdDfFhikqrtTvVwxXyYzZ -a 132 -b 65536 -e malloc -E HOME -I 1 -o /tmp/ltrace.abyss.log -O 999 -p 1 -P /lib/x86_64-linux-gnu -s 1048576 -S time -u 80 -U 132 ionice -c 1 -n 0 caffeinate -dimsu -t 86400 -w 1 setsid -cfw chrt -f 99 taskset -c 0-63 nsenter -aceiFmnpruUCTwWZ -t 1 -S 0 -G 0 -N 3 -- numactl -C 0-63 -m all choom -n -1000 sg nogroup watch -dgtecxbp -n 1 flock -nsux -w 3600 -E 42 /tmp/lock.of.ages chroot /newroot/of/all/evil runuser -l -u nobody -g nogroup -G wheel unshare -cfmnpuUirCT -R /root -w /wd -S 1000 -G 1000 -l /ns -- prlimit --nofile=1048576 --nproc=unlimited cpulimit -l 1 rlwrap -acirN -f /usr/share/dict/words -s 999999 -b x -H /tmp/history.of.madness -p magenta -S p1 timeout -k 1 -s KILL 86400 pkexec fakeroot unbuffer chronic valgrind daemonize firejail sem systemd-run dbus-run-session tsocks sudo -kE -u www-data su -l app stdbuf -oL env -0iv -C /srv DATABASE_URL=postgres://doom:fire@localhost/inferno REDIS_URL=redis://localhost:6379/0 SECRET_KEY=hunter2 API_KEY=sk-AAAA doas -n -u _deploy nice -n -10 nohup strace -cfkqrTvV -e trace=network -s 4096 -o /tmp/net.log ltrace -cfhikrtTvV -e open -s 4096 -o /tmp/ssl.log ionice -t -c 2 -n 7 caffeinate -im -t 3600 setsid -f chrt -r 50 taskset -c 0 nsenter -aceZTwW -t 2 -S 1 -G 1 -N 4 -- -n numactl -absH -i all -w 1 -P 2 -- choom -n 500 flock -x -w 60 -E 1 /tmp/final.lock chroot /srv/jail runuser -u app -g app unshare -cfmnpuUirCT -R /nr -S 500 -G 500 -l /ns2 -- prlimit --memlock=unlimited cpulimit -l 100 pkexec -u admin --keep-cwd fakeroot -u -s /tmp/save -- unbuffer -p chronic -ev -- valgrind -qv --tool=memcheck -- torify -v torsocks -diq6 -a 127.0.0.1 -P 9050 -u tor -p pass tsocks proxychains4 -q -f /etc/pc.conf daemonize -av -c /tmp -u www -- firejail --private -- sem -j 4 -- systemd-run -dGqt -u unit -p prop -- dbus-run-session -- nocache -n 2 -- fakechroot -s -l /lib -- ccache distcc -j dbus-launch --exit-with-session -- eatmydata -- catchsegv sudo -kE -u root su root stdbuf -o0 env -i PATH=/usr/bin LAST_WORDS=goodbye doas -n -u root nice -n 0 nohup time -v gco"
    assert $ZPWR_VARS[cachedRegexMatched] same_as 'true'
}
